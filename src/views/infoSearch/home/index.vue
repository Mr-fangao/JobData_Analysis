...
<style lang="less">
	#viewDiv {padding: 0;position: absolute;height: 100%;width: 100%;background: #fcf9f2;}
	.main .container-fluid {padding: 0 0px;}
	.search {position: absolute;top: 2px;left: 40px;}
	.wrapperBox {position: relative;top: 5px;}
	.list-wrapper {padding: 10px;overflow-y: auto;}
	.esri-layer-list__item-title {margin-left: 5px;padding-left: 5px;margin-top: 5px;}
	#switchbasemap {float: left;padding: 0 10px 0 4px;height: 30px;line-height: 30px;background: #ffffff;box-shadow: 0 1px 2px rgba(0, 0, 0, 0.3);transition: all 0.2s;cursor: pointer;}
	.ivu-input-group-prepend .ivu-select-selection {border-radius: 0;margin: -5px -1px;border-color: #19be6b;}
	.ivu-input {border-radius: 0;border-color: #19be6b;padding-right: 75px;}
	.ivu-input-wrapper > i {width: 40px;font-size: 16px;background: #19be6b;color: white;cursor: pointer;}
	.close-wrapper {z-index: 2;position: relative;float: right;top: -22px;right: 40px;width: 30px;text-align: center;border-left: 1px solid #eeeeee;cursor: pointer;}
