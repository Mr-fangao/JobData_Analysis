	...
	<div>
		<Modal v-model="dialog1" footer-hide :mask-closable="false" width="380" draggable>
			...
			<Tabs size="small">
				<TabPane label="城市查询">
					<Form :label-width="75">
						<FormItem label="城市：" prop="zoning">
							<Select v-model="Street" placeholder="选择城市">
								<Option v-for="item in streetList" :key="item.value" :value="item.value">{{item.label}}
								</Option>
							</Select>
						</FormItem>
	...
	export default {
		...
		data() {
			return {
				...
				streetList: [
					{value: "杨子街道",label: "杨子街道"},
					{value: "大王街道",label: "大王街道"},
					{value: "章广镇",label: "章广镇"},
					{value: "黄泥冈",label: "黄泥冈"},
					{value: "珠龙镇",label: "珠龙镇"},
					{value: "大柳镇",label: "大柳镇"},
					...
					{value: "西涧街",label: "西涧街"},
					{value: "乌衣镇",label: "乌衣镇"},
					{value: "龙蟠街道",label: "龙蟠街道"}
				],
				columns1: [
					{title: "设施名称",key: "name",align: "center"},
					{title: "设施数量",key: "number",align: "center"}
				],
				data1: [
					{key: "medical",name: "医疗保健",number: ""},
					{key: "school",name: "学校",number: ""},
					{key: "govermentAgencies",name: "政府机构",number: ""},
					{key: "telecomHouse",name: "电讯营业厅",number: ""},
					{key: "ticket",name: "售票点",number: ""},
					{key: "publicFacilities",name: "公共设施",number: ""},
					{key: "station",name: "车站",number: ""}
				],
				Street: "",
				myChart: null,
				automyChart: null
					...
					if (res.status === 1) {
						...
						_this.automyChart.setOption({
							...
							xAxis: [{
								...
								axisLine: {show: true,lineStyle: {type: "dotted",color: "#696969"}}
							}],
							yAxis: [{type: "value"}],
							series: [{
								name: "数量",type: "bar",barWidth: "40%",data: yDate,
